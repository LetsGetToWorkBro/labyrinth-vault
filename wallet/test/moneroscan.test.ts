...
describe('adding it up', () => {
  const one = { txid: 'a'.repeat(64), height: 1, index: 0, key: 'k1', amount: 100n, unknownBecause: null };
  const two = { txid: 'a'.repeat(64), height: 1, index: 1, key: 'k2', amount: 250n, unknownBecause: null };
  const hidden = { txid: 'b'.repeat(64), height: 2, index: 0, key: 'k3', amount: null, unknownBecause: 'no' };
