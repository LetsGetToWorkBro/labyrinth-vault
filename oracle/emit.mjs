...
const PATH = 'test/fixtures/monero-keyimages.json';
const text = JSON.stringify(fixture, null, 2) + '\n';

if (!check) {
  writeFileSync(PATH, text);
  console.log(`oracle: wrote ${PATH} (${cases.length} cases)`);
  process.exit(0);
}
...
/* A field-level diff rather than "they differ", because the useful question is
 * always which value moved. */
